...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { address: @home.address, age: @home.age, money: @home.money, name: @home.name } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { address: @home.address, age: @home.age, money: @home.money, name: @home.name } }
